...
namespace lab_05
{
    public class ModelTest
    {
        ...
        public double F0, T0, S;
        public double alpha2, alpha3, alpha4;
        public ModelTest(double a1, double b1, double c1, double m1, double f0, double beta,
        ...
        public double[] RunMethod2(double[] a, double[] b, double[] c, double[] d)
        {
        ...
        public double[] RunMethod3(double[] a, double[] b, double[] c, double[] d)
        {
            double[] y = new double[b.Length];
            double[] xi = new double[b.Length - 1];
            double[] eta = new double[b.Length - 1];
        ...
        public double[] NextLayerXLeft(double[] ym, double[] ym_1, double[] ym1, double[] x, double[] z,
...

        {
            ...
            double[] newy = RunMethod2(a, b, c, d);
            return newy;
        }

        public double[] NextLayerZRight(double[] ym, double[] ym_1, double[] ym1, double[] x, double[] z,
            Double2Func A, Double2Func B, Double2Func C, Double5Func D)

        {
            ...
            double[] newy = RunMethod3(a, b, c, d);
            return newy;
        }
        ...
        public double[][] NextTime(double[] x, double[] z, double[][] y_)
        {
            ...
            for (int i = 1; i < m - 1; i++)
                midy[i] = NextLayerXLeft(y_[i], y_[i - 1], y_[i + 1], x, Double2Arr(z[i], m), An, Bn, Cn, Dn);
            for (int i = 0; i < n; i++)
                midy[0][i] = midy[1][i];
            midy[^1] = new double[n];
            for (int i = 0; i < n; i++)
            ...
            newy[0] = new double[m];
            for (int i = 1; i < n - 1; i++)
                newy[i] = NextLayerZRight(midy[i], midy[i - 1], midy[i + 1], Double2Arr(x[i], n), z, Am, Bm, Cm, Dm);
